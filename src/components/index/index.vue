<template>
	<div>
		<div id="Tl_search">
			<input type="text" id="Tl_search_key" placeholder="搜索">
		...
		<div id="Tl_main_content">
			...
			<router-link to="/page/4" class="Tl_nav3">
				<div></div>
			</router-link>
			...
			<div class="clear">
				...
				<router-link to="/page/20">
					<div id="Tl_Combination_Bottom"></div>
				</router-link>
			</div>
			<router-link to="/page/22" class="Tl_nav4">
				<div></div>
			</router-link>
			<div style="width:100%;height:15rem;" class="clear">
				<router-link to="/page/23">
					<router-link to="/page/25">
			...
			<div style="text-align:center;">
				...
				<p style="font-size:12px;color:#ccc;">工作时间：9:00--18:00</p>
			</div>
		</div>
		<div id="Tl_bottom">
			<router-link to="/">
